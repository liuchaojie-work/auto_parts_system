...
<%--                                <div class="col-sm-9">--%>
<%--                                    <input type="text" class="form-control" id="inputBrandName" name="b_name" placeholder="请输入品牌名...">--%>
...
<%--                                <div class="col-sm-9">--%>
<%--                                    <input type="text" class="form-control" id="inputBrandFactory" name="b_factory" placeholder="请输入厂家...">--%>
<%--                                    <span class="help-block small msg-info" >Help block with success</span>--%>
<%--                                </div>--%>
<%--                            </div>--%>
...
<%--                                <div class="col-sm-9">--%>
<%--                                    <input type="text" class="form-control" id="inputBrandPlace" name="b_place" placeholder="请输入产地...">--%>
<%--                                    <span class="help-block small msg-info">Help block with success</span>--%>
<%--                                </div>--%>
<%--                            </div>--%>
...
<%--                                <div class="col-sm-9">--%>
<%--                                    <input type="text" class="form-control" id="inputBrandRemark" name="b_remark" placeholder="请输入备注...">--%>
<%--                                    <span class="help-block small msg-info" >Help block with success</span>--%>
<%--                                </div>--%>
<%--                            </div>--%>
