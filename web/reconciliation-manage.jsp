    ...
    <div class="content-wrapper">
        ...
        <div>
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-folder"></i> 账务管理</a></li>
                    <li><a href="#">对账</a></li>
                    <li class="active">来往账目表</li>
                </ol>
            </section>
            <!-- 内容头部 /-->
            <!-- 正文区域 -->
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-box">
                            ...
                            <!--数据列表-->
                            <table id="pay-list-list" class="table table-bordered table-striped table-hover dataTable">
                                <thead>
                                <tr>
                                    <th class="" style="padding-right:0px;">
                                        <input id="pay-list-selall" type="checkbox">
                                    </th>
                                    <th>#</th>
                                    <th>付款时间</th>
                                    <th>客户id</th>
                                ...
                                <tr>
                                    <th colspan="9" style="text-align: right">总计(未付)：</th>
                                    <td colspan="3" style="text-align: left">1000</td>
                                </tr>
                                </tbody>
                            </table>
                            <!--数据列表/-->
