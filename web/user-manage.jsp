...
<script>
    ...
    function load(currentPage, pageSize, condition) {
        $.get("user/pageQueryAllCustomer",{"currentPage":currentPage, "pageSize":pageSize, "condition":condition}, function (pb) {
            ...
            for(var i = 0; i < pb.list.length; i++){
                ...
                var tr =
                    ...
                    '                                        <td class="text-center">\n' +
                    '                                            <input type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#changeCustomer" onclick="findCustomerByUserId(\''+listElement.userId+'\')" value="修改"/>\n' +
                    '                                            <input type="button" class="btn btn-danger btn-xs" onclick="deleteCustomerByUserId(\''+listElement.userId+'\')" value="删除"/>\n' +
                    '                                        </td>\n' +
                    '                                    </tr>';
                info_list+=tr;
            }
            $("#customer-list tbody").html(info_list);
            window.scrollTo(0,0);
        });
    }
